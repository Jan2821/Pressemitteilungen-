...
export const Preview: React.FC<PreviewProps> = ({ data }) => {
  ...
  return (
    <div className="w-full h-full flex justify-center bg-gray-100 p-4 print:p-0 print:bg-white overflow-y-auto print:overflow-visible">
      <div 
        className="bg-white shadow-lg print:shadow-none w-[210mm] min-h-[297mm] p-[20mm] box-border relative print:w-full print:h-auto"
        id="print-area"
      >
        {/* Header Section */}
        ...
        {/* Body Text */}
        <div className="prose max-w-none font-serif text-gray-800 leading-relaxed mb-10 whitespace-pre-wrap">
        ...
        {(data.aboutCompany) && (
          <div className="bg-gray-50 p-6 rounded-md mb-8 print:bg-transparent print:p-0 print:border-t print:border-gray-300 print:rounded-none">
